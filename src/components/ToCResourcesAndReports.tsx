            ...
            <section className="p-10 md:p-20 md:pt-0">
                ...
                <section className="grid grid-cols-1  gap-4 md:gap-20">
                    {ResourcesAndReportsCards.map((ResourcesAndReportsCard: ResourcesAndReportsCardsProps) => (
                        <div key={ResourcesAndReportsCard.subHeading} className="w-full flex flex-col md:flex-row  gap-10  mb-20 md:mb-0">
                            ...
                            <section className="flex-grow relative min-w-0 md:min-w-[50%] md:flex-basis[50%] ">
                                <Image height="330" width="520" src={ResourcesAndReportsCard.image} alt={ResourcesAndReportsCard.alt} className="  md:h-90 md:w-auto lg: h-full w-full fill-current" />
                            </section>
                            <section className="flex-grow">
                                ...
                                <h1 className={`mb-4 text-black text-2xl font-semibold leading-8 ${josefinSans.className}`}>{ResourcesAndReportsCard.subHeading}</h1>
                                {isClient && (
                                    <TrunctableText text={ResourcesAndReportsCard.body} maxLength={150} />
                                )}
                                <h6 className={`mb-6 text-black text-sm md:text-base font-normal leading-8 ${josefinSans.className}`}>{ResourcesAndReportsCard.cta}</h6>
                                <div className="flex">
