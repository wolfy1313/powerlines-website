    ...
    <div className='flex flex-col items-center justify-center bg-white our-principles-shadow px-8 max-h-[379px] xs:w-[611px] md:h-[379px] p-10' >
        ...
        <section>
            ...
            <section className="flex items-center  gap-4" >
                ...
                {/* Heading*/}
                <h1 className={`text-md  sm:text-3xl font-semibold sm:leading-9 ${josefinSans.className}`}> {heading}</h1>
            </section>
        
            {/* Text Section */}
            <section>
                <p className={`text-sm sm:text-xl font-normal leading-7 mt-[2rem] pr-4 ${playfairDisplay.className}`}>{text}</p>
            </section>
        </section>
    </div>
