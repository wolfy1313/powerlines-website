...
<p className={`text-base md:text-xl font-normal leading-9 mb-8  ${playfairDisplay.className}`}>{body}</p> <p className={`text-base md:text-sm font-normal leading-9 ${playfairDisplay.className}`}>{body2}</p>
